...
export default function Navbar() {
  return (
    <header className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-7xl mx-auto flex items-center justify-between px-6 py-3.5 rounded-2xl bg-black/50 border border-white/15 shadow-xl backdrop-blur-xl text-white">
        <a 
          href="#" 
          aria-label="Home"
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <a
            ...
            aria-label="GitHub"
            className="text-zinc-400 hover:text-white transition-colors duration-200 p-1.5 rounded-lg hover:bg-white/10"
          >
