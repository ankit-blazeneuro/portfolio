...
export default function Footer() {
  ...
  return (
    <footer className="w-full max-w-7xl mx-auto mt-6 sm:mt-10 pt-6 pb-2 px-4 sm:px-12 border-t border-zinc-800/80 font-space-mono text-xs sm:text-sm text-zinc-400 select-none">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left font-space-mono">
        {/* Left Side: Copyright */}
        <div className="text-zinc-400 font-space-mono">
